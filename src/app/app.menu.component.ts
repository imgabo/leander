...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            {
                label: 'Administración', icon: 'pi pi-fw pi-shield', routerLink: ['/administracion'],
                items: [
                    {label: 'Productos', icon: 'pi pi-fw pi-box', routerLink: ['/administracion/productos']},
                    {label: 'Categorias', icon: 'pi pi-fw pi-plus', routerLink: ['/administracion/categorias']},
                    {label: 'Estados', icon: 'pi pi-fw pi-plus', routerLink: ['/administracion/estados']},
                    {label: 'Localidades', icon: 'pi pi-fw pi-plus', routerLink: ['/administracion/localidades']},
                ]
            },
            {
